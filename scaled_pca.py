...
metrics1 = m1.fit(df1_train, freq = 'D', epochs = 150, validation_df = df1_test, progress = None)
metrics1

forecast1 = m1.predict(df1)
m1.plot(forecast1)

metrics2 = m2.fit(df2_train, freq = 'D', epochs = 150, validation_df = df2_test, progress = None)
metrics2

forecast2 = m2.predict(df2)
m2.plot(forecast2)

metrics3 = m3.fit(df3_train, freq = 'D', epochs = 150, validation_df = df3_test, progress = None)
metrics3

forecast3 = m3.predict(df3)
m3.plot(forecast3)

metrics4 = m4.fit(df4_train, freq = 'D', epochs = 150, validation_df = df4_test, progress = None)
metrics4

forecast4 = m4.predict(df4)
m4.plot(forecast4)

metrics5 = m5.fit(df5_train, freq = 'D', epochs = 150, validation_df = df5_test, progress = None)
metrics5
