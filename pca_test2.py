...
# region Temperature Only (No AOD)
...
metrics1t = m1t.fit(df1t_train, freq = 'D', epochs = 1000, validation_df = df1t_test, progress = None)
metrics1t

forecast1t = m1t.predict(df1t)
m1t.plot(forecast1t)

metrics2t = m2t.fit(df2t_train, freq = 'D', epochs = 1000, validation_df = df2t_test, progress = None)
metrics2t
