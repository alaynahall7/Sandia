...
pca_ct = PCA(n_components = 5)
pca_ca = PCA(n_components = 5)
...
#convert PCA back to original space and compare
ct_orig = np.dot(principalComponents_ct,pca_ct.components_)
...
ct_orig.head()
ct_orig_backscaled.head()

ca_orig = np.dot(principalComponents_ca,pca_ca.components_)
